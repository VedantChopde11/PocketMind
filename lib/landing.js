...
export const TESTIMONIALS = [
  {
    quote:
      "PocketMind made tracking shared expenses effortless. Our weekend trips are finally drama-free, and settling up takes just a few taps.",
    name: "Priya Sharma",
    image: "/testimonials/PriyaSharma.png",
    role: "Software Engineer",
  },
  {
    quote:
      "The smart expense insights helped me understand where my money goes every month. It's now an app I use almost every day.",
    name: "Rahul Mehta",
    image: "/testimonials/RahulMehta.jpg",
    role: "Product Designer",
  },
  {
    quote:
      "Managing apartment expenses with roommates has never been this simple. Everyone knows who paid and who owes—no awkward conversations.",
    name: "Ananya Verma",
    image: "/testimonials/AnanyaVerma.png",
